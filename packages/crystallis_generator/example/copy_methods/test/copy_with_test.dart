...
import 'package:copy_methods_example/crystals.data.g.dart';

Future<void> main() async {
  group('copyWith', () {
    group('shallow', () {
      test('exact values, different instance', () {
        final data = const ShallowTestData(
          value: 'test',
          nullableValue: 42,
          listValue: ['a'],
        );
      ...
      test('copyFrom', () {
        ...
        final other = const ShallowTestData(
          value: 'other',
          nullableValue: null,
          listValue: ['b'],
        );
